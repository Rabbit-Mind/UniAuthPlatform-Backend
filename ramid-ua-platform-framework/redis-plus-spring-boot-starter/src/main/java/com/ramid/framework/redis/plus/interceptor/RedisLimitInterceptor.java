...
package com.ramid.framework.redis.plus.interceptor;

import com.ramid.framework.redis.plus.RedisLimitHelper;
import com.ramid.framework.redis.plus.anontation.RedisLimit;
import com.ramid.framework.redis.plus.utils.RedisAopUtils;
...
public class RedisLimitInterceptor {
    ...
    @Pointcut("@annotation(com.ramid.framework.redis.plus.anontation.RedisLimit)")
