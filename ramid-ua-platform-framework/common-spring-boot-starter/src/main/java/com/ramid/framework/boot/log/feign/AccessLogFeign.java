...
package com.ramid.framework.boot.log.feign;
...
import static com.ramid.framework.boot.log.feign.AccessLogFeign.FEIGN_CLIENT_NAME;
...
public interface AccessLogFeign {
    ...
    String FEIGN_CLIENT_NAME = "ramid-ua-platform-iam";
