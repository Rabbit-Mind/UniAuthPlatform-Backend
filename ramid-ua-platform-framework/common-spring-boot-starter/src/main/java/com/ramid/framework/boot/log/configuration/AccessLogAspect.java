...
import com.ramid.framework.boot.log.AccessLogUtil;
import com.ramid.framework.boot.log.event.AccessLogEvent;
...
public class AccessLogAspect {
     ...
     */
    @Pointcut("execution(public * com.ramid..*.*(..)) && @annotation(com.ramid.framework.commons.annotation.log.AccessLog)")
