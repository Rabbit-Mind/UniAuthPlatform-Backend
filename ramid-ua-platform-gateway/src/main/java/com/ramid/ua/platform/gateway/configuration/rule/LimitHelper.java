package com.ramid.ua.platform.gateway.configuration.rule;
...
import static com.ramid.ua.platform.gateway.configuration.rule.GatewayRule.Constants.DEFAULT_RULE_LIMIT_TOTAL;
import static com.ramid.ua.platform.gateway.configuration.rule.GatewayRule.Constants.GLOBAL_RANGE;
import static com.ramid.ua.platform.gateway.configuration.rule.GatewayRule.GatewayRuleEnum.RULE_LIMIT;
